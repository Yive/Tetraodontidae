...
public class PufferfishVersionFetcher implements VersionFetcher {
	...
	private static final URI JENKINS_URI = URI.create("https://ci.yive.dev/job/Pufferfish/job/1.21.8/lastSuccessfulBuild/buildNumber");
	private static final String GITHUB_FORMAT = "https://api.github.com/repos/Yive/Tetraodontidae/compare/ver/1.21.8...%s";
